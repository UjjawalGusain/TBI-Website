  ...
  return (
    ...
    <div className=' w-[90%] h-96 bg-white rounded-3xl flex items-center justify-center text-center p-4 flex-col md:flex-row'>
      ...
      <div className='relative w-[60%] h-[95%] m-5 mr-2 rounded-xl overflow-hidden'>
        ...
        <a href={link}><img src="https://raw.githubusercontent.com/UjjawalGusain/TBI-Website/main/assets/icons8-link-48.png" className='hidden bottom-0 right-0 size-8 opacity-20 hover:opacity-40 border-2 border-black m-1 absolute md:block'/></a>
      </div>
    </div>
